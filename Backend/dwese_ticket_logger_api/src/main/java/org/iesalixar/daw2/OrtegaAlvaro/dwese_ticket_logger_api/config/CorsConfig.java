...
public class CorsConfig {
    ...
    public CorsWebFilter corsWebFilter() {
        ...
        // Asegúrate de tener la variable 'allowedOrigins' definida en tu clase (ej. @Value("${cors.allowed-origins}"))
        // O reemplaza List.of(allowedOrigins) por List.of("*") para pruebas.
